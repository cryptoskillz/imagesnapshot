...
wrangler pages dev _site --port 8789 --d1=DB  --kv=datastore --persist --binding SECRET=fdfdf BROWSERLESSTOKEN=62803a1e-84c3-48a6-b3e1-505c4fad2e22   --local --live-reload  &
